...
function getAbsoluteAssetUrl(e) {
    return  'https://www.stephanieskinnerfamilydental.com/assets' + e
}
...
var _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (e) {
    ...
    }, bufferHeight = 200, deferModules = ["gallery", "prodcatalog", "shopfilter", "instagramfeed"],
    ignoredLibs = ["instagramfeed"], deferCSSEnabled = document.querySelector("body").hasAttribute("data-defercss"),
    requiredLibs = {}, requiredExtLibs = {}, isInTool = document.body.hasAttribute("data-istool"),
    isSandbox = document.body.hasAttribute("data-sandbox"),
    isPhantomJS = ["PhantomJS/monoTool"].indexOf(navigator.userAgent) > -1,
    isSitePageVisitor = ["Puppeteer/sitePageVisitor"].indexOf(navigator.userAgent) > -1,
    isPuppeteer = window.navigator.userAgent.includes("Puppeteer/imageSizesCrawler");
!function (e, t, n) {
    function r(e, t) {
    ...
    function o() {
        ...
        for (var l in b) if (b.hasOwnProperty(l)) {
            ...
            for (o = r(t.fn, "function") ? t.fn() : t.fn, i = 0; i < e.length; i++) a = e[i], s = a.split("."), 1 === s.length ? j[s[0]] = o : (!j[s[0]] || j[s[0]] instanceof Boolean || (j[s[0]] = new Boolean(j[s[0]])), j[s[0]][s[1]] = o), y.push((o ? "" : "no-") + s.join("-"))
        }
    }

    function i(e) {
        var t = A.className, n = j._config.classPrefix || "";
        if (L && (t = t.baseVal), j._config.enableJSClass) {
            var r = new RegExp("(^|\\s)" + n + "no-js(\\s|$)");
            t = t.replace(r, "$1" + n + "js$2")
        }
        j._config.enableClasses && (t += " " + n + e.join(" " + n), L ? A.className.baseVal = t : A.className = t)
    }
    ...
    function d(e, n, r, o) {
        var i, a, s, d, c = "modernizr", f = l("div"), m = u();
        if (parseInt(r, 10)) for (; r--;) s = l("div"), s.id = o ? o[r] : c + (r + 1), f.appendChild(s);
        return i = l("style"), i.type = "text/css", i.id = "s" + c, (m.fake ? m : f).appendChild(i), m.appendChild(f), i.styleSheet ? i.styleSheet.cssText = e : i.appendChild(t.createTextNode(e)), f.id = c, m.fake && (m.style.background = "", m.style.overflow = "hidden", d = A.style.overflow, A.style.overflow = "hidden", A.appendChild(m)), a = n(f, e), m.fake ? (m.parentNode.removeChild(m), A.style.overflow = d, A.offsetHeight) : f.parentNode.removeChild(f), !!a
    }
    ...
    function h(e, t, o, i) {
        ...
        for (var c, f, m, g, h, v = ["modernizr", "tspan", "samp"]; !J.style && v.length;) c = !0, J.modElem = l(v.shift()), J.style = J.modElem.style;
        for (m = e.length, f = 0; m > f; f++) if (g = e[f], h = J.style[g], s(g, "-") && (g = a(g)), J.style[g] !== n) {
    ...
    function v(e, t, n, o, i) {
        var a = e.charAt(0).toUpperCase() + e.slice(1), s = (e + " " + C.join(a + " ") + a).split(" ");
        return r(t, "string") || r(t, "undefined") ? h(s, t, o, i) : (s = (e + " " + k.join(a + " ") + a).split(" "), f(s, t, n))
    }
    ...
    S._prefixes = x;
    var A = t.documentElement, L = "svg" === A.nodeName.toLowerCase(), E = "Moz O ms Webkit",
        k = S._config.usePrefixes ? E.toLowerCase().split(" ") : [];
    S._domPrefixes = k;
    var q = "CSS" in e && "supports" in e.CSS, T = "supportsCSS" in e;
    j.addTest("supports", q || T);
    ...
    j._q.unshift(function () {
        ...
        return h([e], n, t, r)
    }, S.testAllProps = v, S.prefixed = function (e, t, n) {
        return 0 === e.indexOf("@") ? _(e) : (-1 != e.indexOf("-") && (e = a(e)), t ? v(e, t, n) : v(e, "pfx"))
    }, S.testAllProps = w, j.addTest("backgroundsize", w("backgroundSize", "100%", !0)), j.addTest("borderradius", w("borderRadius", "0px", !0)), j.addTest("flexbox", w("flexBasis", "1px", !0)), j.addTest("csstransforms", function () {
    ...
    function d(e, n) {
        var d, c, f;
        i(e) ? d = e : o(e) && (d = e._url || e.src, c = e.attrs, f = e.timeout), n = n || r, c = c || {};
        var m, v, y = t.createElement("script");
        f = f || g.errorTimeout, y.defer = !0, y.src = d, w && (o(e) && e.forceWindow || (y.event = "onclick", y.id = y.htmlFor = c.id || a()));
        for (v in c) y.setAttribute(v, c[v]);
        y.onreadystatechange = y.onload = function () {
            if (!m && l(y.readyState)) {
                if (m = 1, w) try {
                    o(e) && e.forceWindow || y.onclick()
                } catch (t) {
                    throw new Error("Script Error: " + d + " msg: " + JSON.stringify(t))
                }
            ...
            m || (m = 1, n(new Error("Timeout: " + d)), y.parentNode.removeChild(y))
        }, f), s(), p.parentNode.insertBefore(y, p)
    }
    ...
    function c(n, a) {
        ...
        a = a || r, c.href = l, c.rel = "stylesheet", c.media = "only x", c.type = "text/css", h(function () {
            c.media = d.media || "all"
        });
        for (u in d) c.setAttribute(u, d[u]);
        s(), p.parentNode.appendChild(c), h(function () {
            a.call(e)
        })
    }
    ...
    function g(e, t, n) {
        var r;
        o(e) && (r = e, e = r.src || r.href), e = g.urlFormatter(e, t), r ? r._url = e : r = {_url: e};
        var i = f(e);
        if ("js" === i) d(r, n); else {
    ...
    var p, h = e.setTimeout, v = 0, w = ({}.toString, !1);
    return g.errorTimeout = 1e4, g.injectJs = d, g.injectCss = c, g.urlFormatter = m, g
}(window, document);
var ASSETSURL = isPhantomJS || isSitePageVisitor || isPuppeteer || !window.ASSETSURL ? "/assets" : window.ASSETSURL,
    releaseTimestamp = isNaN(parseInt("#RELEASETS#")) ? (new Date).getTime() : parseInt("#RELEASETS#"),
    _monoLoader = function (e, t) {
        function n() {
            g(), isPhantomJS || isSitePageVisitor || isPuppeteer || isInTool || isSandbox || t.injectJs(getAbsoluteAssetUrl("/js/monotracker.js?")), t.injectJs(getAbsoluteAssetUrl("/js/jquery-" + (e.borderradius ? "modern" : "legacy") + ".js"), function () {
                p.waitFor(function () {
        ...
        function o() {
            ...
            var t = ["cookie", "form", "checkout.step1", "gmaps", "osmap", "emailshare", "businesscardshare", "cart", "crmoverlays", "crmlogin", "singleproduct", "engagements"];
            $("*[data-req]").each(function (n, r) {
                var o = $(r).attr("data-req").split(",");
                for (var i in o) {
                    var a = o[i];
                    "" !== a && (e.indexOf(a) > -1 && document.body.hasAttribute("data-socialoptin") || (0 === a.indexOf("ext-") ? (a = a.replace("ext-", ""), requiredExtLibs.hasOwnProperty(a) || (requiredExtLibs[a] = {loaded: !1})) : (requiredLibs.hasOwnProperty("lang") || -1 === t.indexOf(a) || (requiredLibs.lang = {loaded: !1}), requiredLibs.hasOwnProperty(a) || ignoredLibs.includes(a) || (requiredLibs[a] = {loaded: !1}, "lightbox" === a && (requiredLibs.slider = {loaded: !1})))))
                }
            }), requiredLibs.hasOwnProperty("lang") || $("*[data-req-lazy]").each(function (e, n) {
        ...
        function i(e) {
            ...
            for (var i in requiredLibs) if (!requiredLibs[i].loaded) {
            ...
            var u = function (e) {
                if (!requiredExtLibs[e].loaded) {
                    ...
                    var l = !0,
                        u = n.match(/instagram.com\/.*embeds.js|youtube.com\/iframe_api|maps.googleapis.com\/maps\/api\/js/);
                    u && document.querySelector('[data-cookiebot="true"]') && (l = !1, p.waitFor(function () {
                        ...
                        void 0 !== ("undefined" == typeof i ? "undefined" : _typeof(i)) && i === !1 && (o.type = "text/plain"), t.injectJs({
                            src: n.replace(/&amp;/g, "&"),
                            attrs: o
                        }, r(e, !0))
                    }, 2e4, 50));
                    var d = n.match(/hcaptcha.com\/1\/api.js\?(render=explicit&amp;)?onload=([^\&]*)/);
                    d && (l = !1, p.waitFor(function () {
                        return "function" == typeof window.formsInitHcaptcha
                    }, function () {
                        var i = "en";
                        void 0 !== $("html").attr("data-lang") && (i = $("html").attr("data-lang"), o.async = "", o.defer = "", o.rel = "preconnect"), n = n + "&hl=" + i, t.injectJs({
                            src: n.replace(/&amp;/g, "&"),
                            attrs: o
                        }, r(e, !0))
                    }, 2e4, 50)), l && t.injectJs({src: n.replace(/&amp;/g, "&"), attrs: o}, r(e, !0))
                }
            };
        ...
        function a(e) {
            var t, n = ["//maps.googleapis.com/maps/api/js", "js.hcaptcha.com/1/api"], r = {}, o = {};
            for (var i in e) for (var a = 0; a < n.length; a++) i.indexOf(n[a]) > -1 && (r[n[a]] || (r[n[a]] = []), r[n[a]].push(i), o[i] = e[i], delete e[i]);
            for (var s in r) {
                var l = [];
                if (r[s].length >= 1) for (var u = 0; u < r[s].length; u++) for (var d = r[s][u].replace(/&amp;/g, "&"), c = d.replace(/(.*\?)/, "").split("&"), f = 0; f < c.length; f++) l.push(c[f]);
                t = r[s][0];
        ...
        function u(e) {
            p.waitFor(function () {
                ...
                if (isInTool && window.parent.iframeGrids && ("gallery" == e || "prodcatalog" == e) && window.parent.iframeGrids.remakeGridsStyle(), !document.querySelectorAll('link[href*="' + ASSETSURL + "/css/" + e + '.css"]').length) {
                    var t = document.createElement("link"),
                        n = document.getElementById("style_site") ? document.getElementById("style_site") : document.getElementById("style_iframestyle");
                    t.rel = "stylesheet", t.href = getAbsoluteAssetUrl("/css/" + e + ".css"), t.onload = function () {
        ...
        function m() {
            window._monoLoader.utils.waitFor(function () {
                ...
                (!e || e && window.CookieConsent && window.CookieConsent.consent.marketing) && window._monoGmaps.init()
            }, 5e3, 800)
        }

        function g() {
            var e = window.location.search.includes("show-engagement") ? window.location.search.split("show-engagement=", 2)[1] : !1;
            if (e) {
                var t = document.querySelector(".skipNavigation"), n = document.getElementsByTagName("body")[0];
                n && n.classList.add("engagementPreviewBody"), t && (t.style.display = "none")
            }
        }
        ...
        var p = {
            makeOptionsObj: function (e) {
                ...
                r = r ? r : 20;
                var o = n ? n : 2e3, i = (new Date).getTime(), a = !1, s = setInterval(function () {
                ...
                get: function (e) {
                    var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : null, n = e + "=",
                        r = document.cookie.split(";");
                    for (var o in r) {
                        var i = r[o].split("="), a = i[0] + "=";
                        if (a.replace(/\s/g, "") === n) return r[o].replace(a.replace(/\s/g, ""), "").replace(/\s/g, "")
                    }
                    return t
                }, set: function (e, t) {
                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : !1, r = e + "=" + t + ";";
                    if (n) {
                        var o = new Date;
    ...
    }(window.Modernizr, window.yepnope), _monoInView = function () {
        function e(e, t) {
        ...
        function n(e) {
            var n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : !1,
                r = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, o = {
                    top: 0,
                    left: 0,
        ...
        function i() {
            ...
            if (!(e >= 20)) return window.quicklink ? void window.quicklink.listen({
                limit: 25,
                throttle: 5
        ...
        function a() {
            window.addEventListener("scroll", o), window.addEventListener("resize", o), window._monoLoader.windowLoaded = !1, window.addEventListener("load", function () {
...
_monoInView.monitorElements(document.querySelectorAll("*[data-req-lazy]"), function (e) {
    e.getAttribute("data-req-lazy").split(",").forEach(function (e) {
        window.yepnope.injectJs(getAbsoluteAssetUrl("/js/" + e + ".js"))
    })
}, {once: !0}), _monoLoader.utils.waitFor(function () {
    return "function" == typeof jQuery
}, function () {
    deferModules.forEach(function (e) {
        if (document.querySelectorAll('[data-req*="' + e + '"]').length) {
            if (!deferCSSEnabled || isSandbox) return window._monoLoader.loadExtraStylesheet(e), void window._monoLoader.loadLibs(e);
            _monoInView.monitorElements(document.querySelectorAll('[data-req*="' + e + '"]'), function () {
                window._monoLoader.loadExtraStylesheet(e), window._monoLoader.loadLibs(e)
