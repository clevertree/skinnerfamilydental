...
export const metadata: Metadata = buildMetaData("The Office")
                                ...
                                <div id="c8354" className="col col-sm-12 col-lg-10 col-md-12">
                                    ...
                                    <div id="m4658" className="module gallery" role="region" aria-label="Slides">
                                        <SlideShow
                                            images={[
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-0014.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 646
                                                },
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-0015.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 631
                                                },
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-0016.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 636
                                                },
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-0017.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 636
                                                },
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-0018.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 649
                                                },
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-020.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 636
                                                },
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-021.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 636
                                                },
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-022.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 636
                                                },
                                                {
                                                    src: '/uploads/img/Dr.StephanieL.Skinner-FamilyDentistry-023.jpg',
                                                    alt: '',
                                                    width: 800,
                                                    height: 636
                                                },
