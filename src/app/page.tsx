                ...
                <div id='p9533' className="container container-fluid">
                    <div className="col col-sm-12">
                        ...
                        <FeatureRow headline="Friendly & Inviting"
                                    ...
                                    imgSrc="/uploads/imgs/Dr.StephanieL.Skinner-FamilyDentistry-005.jpg"
                                    buttonText="TOUR OUR OFFICE"
                                    buttonHref="/the-office"/>
                        <FeatureRow headline="Honest & Affordable"
                                    reverse
                                    className='bg-white'
                                    imgSrc="/uploads/imgs/Dr.StephanieL.Skinner-FamilyDentistry-006.jpg"
                        ...
                        <FeatureRow headline="State of the Art Technology"
                                    className='bg-gray-100'
                                    imgSrc="/uploads/imgs/Dr.StephanieL.Skinner-FamilyDentistry-007.jpg"
                        ...
                        <FeatureRow headline="Unleash Your Brightness with Zoom Professional Teeth Whitening"
                                    reverse
                                    className='bg-white'
                                    imgSrc="/uploads/imgs/Dr.StephanieL.Skinner-FamilyDentistry-008.jpg"
